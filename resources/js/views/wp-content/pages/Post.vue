  ...
  <div class="container mx-auto px-4 w-full md:w-3/4 lg:w-3/5 xl:w-1/2 mt-20">
    ...
    <div v-else>
      <div class="text-lg text-gray-600">
        By
<!--        <router-link-->
<!--          :to="{name: 'post_author', params: {id: wp_post.post_author.ID}}"-->
<!--          class="underline hover:text-black"-->
<!--        >{{ wp_post.post_author.name }}</router-link>in-->
      ...
      <p class="text-gray-700 pb-3 mb-12 whitespace-pre-line">{{ wp_post.content }}</p>
...
<!--              :to="{name: 'post_author', params: {id: wp_post.post_author.ID}}"-->
<!--              class="underline hover:text-black"-->
<!--            >{{ wp_post.post_author.name }}</router-link>-->
          </div>
