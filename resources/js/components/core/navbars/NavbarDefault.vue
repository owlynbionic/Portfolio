<template>
  <header>
    <nav style="z-index: 100" class="navbar navbar-light rm-icon-bar-wrapper">
      <div class="container">
        <ul class="navbar-nav shadow-lg bg-secondary rm-icon-bar is-scrollable inverttooltips">
          <li class="nav-item bg-dark"><router-link :to="{name: 'windows'}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M0 0h24v24H0z" fill="none"/><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg></router-link></li>
          <li class="nav-item"><router-link :to="{name: 'home'}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-house-fill">
            <path fill-rule="evenodd" d="M8 3.293l6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6zm5-.793V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"></path>
            <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"></path>
          </svg></router-link></li>
          <li class="nav-item"><router-link :to="{name: 'projects'}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none">
          ...
          <li class="nav-item"><router-link :to="{name: 'dashboard'}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-server">
          ...
          <li class="nav-item"><router-link :to="{name: 'unity'}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" class="bi bi-controller">
          ...
          <li class="nav-item"><router-link :to="{name: 'music'}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none">
    ...
    <div class="row g-0 justify-content-end sidebar-wrapper" style="min-width: 120px;">
      <div class="col" >
        <div class="row g-0">
            ...
            <nav class="navbar navbar-light navbar-expand-sm">
              <div class="container-fluid">
                <ul class="navbar-nav d-flex d-sm-flex flex-row justify-content-start align-items-center flex-xl-column align-items-xl-start sidebar-list">
                  ...
                  <li class="nav-item"><router-link :to="{name: 'services'}" class="nav-link">Services</router-link></li>
                </ul>
              </div>
            </nav>
          </div>
